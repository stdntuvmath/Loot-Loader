...
#This is the DataLoader that does not trade, it just loads data
# and calculates the EMA200, EMA3900, StdDev10, Variance10, HLEVs, and other values
# and stores them in the LootLoaderDataBase for later use.
...
def Run():
    ...
    try:
        ...
        message = "-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-\r\f"+str(now)+" - BEGIN DATALOADER\r\r-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-\r\f"        
        ...
        #while(True):
            ...
            for symbol in symbolList: 
                ...
                #####################################################
                time.sleep(0.10) # taken out because of the Delete_Todays_Data_Only_for_Symbol adding time between pings            
                #####################################################
                if(lib.Database_Management.Check_LootLoaderDataBase.Check_If_Table_Exists_in_LLDB("lootloaderdatabase","{}_historical".format(symbol))):
                    ...
                    if(counter_ofSymbols <= numberOfSymbols):
                        ...
                        if(lastRowData == None):
                            ...
                            message = "{} of {}. Filling data for: {}\r\f".format(counter_ofSymbols, numberOfSymbols, symbol)
                            print(message)
                            lib.Logging.info(message)
        ...
        message = "-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-\r\f"+str(now)+" - END DATALOADER\r\r-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-\r\f"        
