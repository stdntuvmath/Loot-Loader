...
def Run():
    ...
    try:
        ...
        startTime = now.replace(hour=0, minute=00, second=0)
                ...
                if(lib.Database_Management.Check_LootLoaderDataBase.Check_If_Table_Exists_in_LLDB("lootloaderdatabase","{}_historical".format(symbol))):
                    ...
                    if(counter_ofSymbols <= numberOfSymbols):
                        ...
                        if(lastRowData != None):
                            ...
                            message = "{} of {}. {} - Backfilled to present.".format(counter_ofSymbols, numberOfSymbols,symbol)+"\r\f"
                            print(message)
